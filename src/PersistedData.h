...
namespace PersistedData {
    ...
    public:
        ...
        virtual bool
        Save(SKSE::SerializationInterface *serializationInterface, std::uint32_t type, std::uint32_t version);
    ...
    public:
        virtual bool
        Save(SKSE::SerializationInterface *serializationInterface, std::uint32_t type, std::uint32_t version) override;
    ...
    class ExposureData final : public BaseFormFloat {
    public:
        static ExposureData *GetSingleton() {
            static ExposureData singleton;
            return &singleton;
        }
    ...
    class LastEventData final : public BaseFormFloat, public ISingleton<LastEventData> {
    public:
        const char *GetType() override {
    ...
    enum : std::uint32_t {
        kArousalDataKey = 'OSLA',
        kExposureDataKey = 'OSLB',
        kArousalMultiplierDataKey = 'OSLM',
        kLastCheckTimeDataKey = 'OSLC',
        kLastEventDataKey = 'OSLE',
        kLastOrgasmTimeDataKey = 'OSLO',
        kArmorKeywordDataKey = 'OSLK',
        kActorStateDataKey = 'OARS',
    };

//    constexpr std::uint32_t kSerializationVersion = 2;
//    constexpr std::uint32_t kArousalDataKey = 'OSLA';
//    constexpr std::uint32_t kExposureDataKey = 'OSLB';
//    constexpr std::uint32_t kArousalMultiplierDataKey = 'OSLM';
//    constexpr std::uint32_t kLastCheckTimeDataKey = 'OSLC';
//    constexpr std::uint32_t kLastEventDataKey = 'OSLE';
